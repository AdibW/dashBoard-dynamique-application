...
class DashboardResourceIT {
    ...
    public static Dashboard createEntity() {
        Dashboard dashboard = new Dashboard().name(DEFAULT_NAME).username(DEFAULT_USERNAME);
        return dashboard;
    }
    ...
    public static Dashboard createUpdatedEntity() {
        Dashboard dashboard = new Dashboard().name(UPDATED_NAME).username(UPDATED_USERNAME);
        return dashboard;
    }
    ...
    void putExistingDashboard() throws Exception {
        ...
        updatedDashboard.name(UPDATED_NAME).username(UPDATED_USERNAME);
    ...
    void fullUpdateDashboardWithPatch() throws Exception {
        ...
        partialUpdatedDashboard.name(UPDATED_NAME).username(UPDATED_USERNAME);
