...
import static com.sample.dashboard.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.sample.dashboard.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static com.sample.dashboard.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.sample.dashboard.IntegrationTest;
import com.sample.dashboard.security.AuthoritiesConstants;
